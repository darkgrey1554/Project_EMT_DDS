...
#ifndef _JSON_BACKEND_EXCEPTION_EXCEPTION_HPP_
#define _JSON_BACKEND_EXCEPTION_EXCEPTION_HPP_
...
public:
     ...
     * @param message The message to be returned by what()
     */
   Unsupported(const char* message) noexcept;
...
public:
     ...
     * @param message The message to be returned by what()
     */
    BadParameter(const char* message) noexcept;
...
public:
     ...
     * @param message The message to be returned by what()
     */
  PreconditionNotMet(const char* message) noexcept;
     ...
     * @param message The message to be returned by what()
     */
    PreconditionNotMet(const std::string& message);
...
public:
     ...
     * @param message The message to be returned by what()
     */
    CorruptedFile(const char* message) noexcept;
     ...
     * @param message The message to be returned by what()
     */
 CorruptedFile(const std::string& message);
