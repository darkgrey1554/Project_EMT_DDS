...
int main()
{
...

	{
...

		{
			...
			opc_unit->set_endpoint_url("opc.tcp://LAPTOP-SMDMIQSL:53530/OPCUA/SimulationServer");
			opc_unit->set_namespace_index("3");
			opc_unit->set_password("");
			opc_unit->set_user_name("");
			opc_unit->set_security_mode("Sign");
			opc_unit->set_security_policy("Basic256");
			unit_in.set_id(101);
	...
	std::fstream file_out("config_new.json", std::ios_base::out | std::ios_base::trunc);
