...
int main()
{
...

	{
...

		{
			...
			dds_unit->set_topic_name("from_scada");
...

		{
			...
			sm_unit->set_name_point_sm("to_emt");
			sm_unit->set_size_int_data(100);
			sm_unit->set_size_float_data(100);
