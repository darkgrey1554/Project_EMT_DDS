...
int main()
{
...

	{
...

		{
			...
			opc_unit->set_endpoint_url("opc.tcp://192.168.0.159:53530/OPCUA/SimulationServer");
			opc_unit->set_namespace_index("3");
...

		{
			...
			dds_unit->set_topic_name("prosys_data_out");
...

	{
...

		{
			atech::common::InputUnit unit_in;
			std::shared_ptr<atech::common::DdsConfig> dds_unit = std::make_shared<atech::common::DdsConfig>();
			dds_unit->set_topic_name("prosys_data_in");
			dds_unit->set_type_name("DDSData");
			unit_in.set_id(201);
			unit_in.set_id_map(0);
