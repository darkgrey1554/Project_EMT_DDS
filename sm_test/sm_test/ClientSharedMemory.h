...
namespace emt
{
	...
	class ClientSharedMemory
	{
		...
		struct HeaderSharedMemory
		{
			...
			unsigned long long size_data_int = 0;
			unsigned long long size_data_float = 0;
			unsigned long long size_data_double = 0;
			unsigned long long size_data_char = 0;
			unsigned long long size_str_data = 0;
			unsigned long long size_str = 0;
		};
