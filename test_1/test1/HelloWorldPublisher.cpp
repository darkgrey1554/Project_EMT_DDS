...
public:
    ...
    bool init()
    {
        ...
        auto tcp_transport = std::make_shared<eprosima::fastrtps::rtps::TCPv4TransportDescriptor>();
        ...
        eprosima::fastrtps::rtps::IPLocator::setIPv4(initial_peer_locator, "192.168.56.1");
